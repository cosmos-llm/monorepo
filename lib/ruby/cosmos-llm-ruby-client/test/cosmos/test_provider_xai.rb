...
class TestProviderXai < Minitest::Test
  def setup
    ...
    @provider = Cosmos::Llm::Providers::Xai.new(api_key: 'test_api_key')
  end
  ...
  def test_default_api_key
    ...
    provider = Cosmos::Llm::Providers::Xai.new
  ...
  def test_completion
    ...
    assert_instance_of Cosmos::Llm::Providers::Xai::XaiResponse, response
  ...
  def test_embedding
    ...
    assert_instance_of Cosmos::Llm::Providers::Xai::XaiEmbeddingResponse, response
