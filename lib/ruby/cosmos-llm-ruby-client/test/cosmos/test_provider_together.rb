...
class TestProviderTogether < Minitest::Test
  def setup
    ...
    @provider = Cosmos::Llm::Providers::Together.new(api_key: 'test_api_key')
  end
  ...
  def test_default_api_key
    ...
    provider = Cosmos::Llm::Providers::Together.new
  ...
  def test_completion
    ...
    assert_instance_of Cosmos::Llm::Providers::Together::TogetherResponse, response
  ...
  def test_embedding
    ...
    assert_instance_of Cosmos::Llm::Providers::Together::TogetherEmbeddingResponse, response
