...
class TestProviderOpenAI < Minitest::Test
  def setup
    ...
    @provider = Cosmos::Llm::Providers::OpenAI.new(api_key: 'test_api_key')
  end
  ...
  def test_completion
    ...
    assert_instance_of Cosmos::Llm::Providers::OpenAI::OpenAIResponse, response
  ...
  def test_embedding
    ...
    assert_instance_of Cosmos::Llm::Providers::OpenAI::OpenAIEmbeddingResponse, response
