...
class TestProviderAzureOpenAI < Minitest::Test
  def setup
    ...
    @provider = Cosmos::Llm::Providers::AzureOpenai.new(
  ...
  def test_completion
    ...
    assert_instance_of Cosmos::Llm::Providers::AzureOpenai::AzureOpenaiResponse, response
  ...
  def test_embedding
    ...
    assert_instance_of Cosmos::Llm::Providers::AzureOpenai::AzureOpenaiEmbeddingResponse, response
