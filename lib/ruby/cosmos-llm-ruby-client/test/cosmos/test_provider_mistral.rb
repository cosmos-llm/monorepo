...
class TestProviderMistral < Minitest::Test
  def setup
    ...
    @provider = Cosmos::Llm::Providers::Mistral.new(api_key: 'test_api_key')
  end
  ...
  def test_default_api_key
    ...
    provider = Cosmos::Llm::Providers::Mistral.new
  ...
  def test_completion
    ...
    assert_instance_of Cosmos::Llm::Providers::Mistral::MistralResponse, response
  ...
  def test_embedding
    ...
    assert_instance_of Cosmos::Llm::Providers::Mistral::MistralEmbeddingResponse, response
