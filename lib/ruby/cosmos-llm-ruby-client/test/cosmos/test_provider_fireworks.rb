...
class TestProviderFireworks < Minitest::Test
  def setup
    ...
    @provider = Cosmos::Llm::Providers::Fireworks.new(api_key: 'test_api_key')
  end
  ...
  def test_default_api_key
    ...
    provider = Cosmos::Llm::Providers::Fireworks.new
  ...
  def test_completion
    ...
    assert_instance_of Cosmos::Llm::Providers::Fireworks::FireworksResponse, response
  ...
  def test_embedding
    ...
    assert_instance_of Cosmos::Llm::Providers::Fireworks::FireworksEmbeddingResponse, response
