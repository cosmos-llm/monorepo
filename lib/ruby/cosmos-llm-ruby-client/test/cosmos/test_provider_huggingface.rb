...
class TestProviderHuggingface < Minitest::Test
  def setup
    ...
    @provider = Cosmos::Llm::Providers::Huggingface.new(api_key: 'test_api_key')
  end
  ...
  #   provider = Cosmos::Llm::Providers::Huggingface.new
  ...
  def test_completion
    ...
    assert_instance_of Cosmos::Llm::Providers::Huggingface::HuggingfaceResponse, response
  ...
  def test_embedding
    ...
    assert_instance_of Cosmos::Llm::Providers::Huggingface::HuggingfaceEmbeddingResponse, response
