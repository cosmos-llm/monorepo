...
class TestProviderOpenRouter < Minitest::Test
  def setup
    ...
    @provider = Cosmos::Llm::Providers::OpenRouter.new(api_key: 'test_api_key')
  end
  ...
  def test_default_api_key
    ...
    provider = Cosmos::Llm::Providers::OpenRouter.new
  ...
  def test_completion
    ...
    assert_instance_of Cosmos::Llm::Providers::OpenRouter::OpenRouterResponse, response
  ...
  def test_embedding
    ...
    assert_instance_of Cosmos::Llm::Providers::OpenRouter::OpenRouterEmbeddingResponse, response
