...
class TestProviderGoogle < Minitest::Test
  def setup
    ...
    @provider = Cosmos::Llm::Providers::Google.new(api_key: 'test_api_key')
  end
  ...
  def test_default_api_key
    ...
    provider = Cosmos::Llm::Providers::Google.new
  ...
  def test_completion
    ...
    assert_instance_of Cosmos::Llm::Providers::Google::GoogleResponse, response
  ...
  def test_embedding
    ...
    assert_instance_of Cosmos::Llm::Providers::Google::GoogleEmbeddingResponse, response
