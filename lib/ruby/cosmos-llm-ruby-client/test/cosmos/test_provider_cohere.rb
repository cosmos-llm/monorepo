...
class TestProviderCohere < Minitest::Test
  def setup
    ...
    @provider = Cosmos::Llm::Providers::Cohere.new(api_key: 'test_api_key')
  end
  ...
  def test_default_api_key
    ...
    provider = Cosmos::Llm::Providers::Cohere.new
  ...
  def test_completion
    ...
    assert_instance_of Cosmos::Llm::Providers::Cohere::CohereResponse, response
  ...
  def test_stream
    assert_equal true, Cosmos::Llm::Providers::Cohere.stream?
  end
end
