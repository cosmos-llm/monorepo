...
class TestClient < Minitest::Test
  ...
  def test_initialize_with_provider_name
    client = Cosmos::Llm::Client.new(:openai)
    assert_instance_of Cosmos::Llm::Providers::OpenAI, client.provider
  end
  ...
  def test_provider_class_for_special_cases
    ...
    client = Cosmos::Llm::Client.new(:deepseek)
    assert_instance_of Cosmos::Llm::Providers::DeepSeek, client.provider
  end
end
