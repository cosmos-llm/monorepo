...
class TestProviderDeepSeek < Minitest::Test
  def setup
    ...
    @provider = Cosmos::Llm::Providers::DeepSeek.new(api_key: 'test_api_key')
  end
  ...
  def test_default_api_key
    ...
    provider = Cosmos::Llm::Providers::DeepSeek.new
  ...
  def test_completion
    ...
    assert_instance_of Cosmos::Llm::Providers::DeepSeek::DeepSeekResponse, response
  ...
  def test_embedding
    ...
    assert_instance_of Cosmos::Llm::Providers::DeepSeek::DeepSeekEmbeddingResponse, response
