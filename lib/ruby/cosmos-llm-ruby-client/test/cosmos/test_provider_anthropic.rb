...
class TestProviderAnthropic < Minitest::Test
  def setup
    ...
    @provider = Cosmos::Llm::Providers::Anthropic.new(api_key: 'test_api_key')
  end
  ...
  def test_default_api_key
    ...
    provider = Cosmos::Llm::Providers::Anthropic.new
  ...
  def test_completion
    ...
    assert_instance_of Cosmos::Llm::Providers::Anthropic::AnthropicResponse, response
  ...
  def test_stream_class_method
    assert_equal true, Cosmos::Llm::Providers::Anthropic.stream?
  end
end
