...
class TestProviderPerplexity < Minitest::Test
  def setup
    ...
    @provider = Cosmos::Llm::Providers::Perplexity.new(api_key: 'test_api_key')
  end
  ...
  def test_default_api_key
    ...
    provider = Cosmos::Llm::Providers::Perplexity.new
  ...
  def test_completion
    ...
    assert_instance_of Cosmos::Llm::Providers::Perplexity::PerplexityResponse, response
  ...
  def test_embedding
    ...
    assert_instance_of Cosmos::Llm::Providers::Perplexity::PerplexityEmbeddingResponse, response
