...
class TestProviderOpencode < Minitest::Test
  def setup
    ...
    @provider = Cosmos::Llm::Providers::Opencode.new(api_key: 'test_api_key')
  end
  ...
  def test_default_api_key
    ...
    provider = Cosmos::Llm::Providers::Opencode.new
  ...
  def test_completion
    ...
    assert_instance_of Cosmos::Llm::Providers::Opencode::OpencodeResponse, response
  ...
  def test_embedding
    ...
    assert_instance_of Cosmos::Llm::Providers::Opencode::OpencodeEmbeddingResponse, response
