...
module Cosmos
  module Llm
    module Providers
      ...
      class Xai < Cosmos::Llm::Providers::Base
        ...
        def default_api_key
          begin
            Cosmos::Llm.configuration.xai&.api_key
        ...
        # @raise [Cosmos::Llm::InvalidRequestError] For 400-499 responses
        # @raise [Cosmos::Llm::ServerError] For 500-599 responses
