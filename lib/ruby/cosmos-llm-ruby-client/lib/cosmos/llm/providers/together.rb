...
module Cosmos
  module Llm
    module Providers
      ...
      class Together < Cosmos::Llm::Providers::Base
        ...
        def default_api_key
          begin
            Cosmos::Llm.configuration.together&.api_key
        ...
        # @raise [Cosmos::Llm::AuthenticationError] On 401 status
        # @raise [Cosmos::Llm::RateLimitError] On 429 status
        # @raise [Cosmos::Llm::InvalidRequestError] On 400-499 status
        # @raise [Cosmos::Llm::ServerError] On 500-599 status
        # @raise [Cosmos::Llm::APIError] On other error statuses
