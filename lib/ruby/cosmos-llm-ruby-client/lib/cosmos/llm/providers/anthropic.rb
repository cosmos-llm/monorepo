...
module Cosmos
  module Llm
    module Providers
      ...
      #   provider = Cosmos::Llm::Providers::Anthropic.new(api_key: 'your-api-key')
      ...
      class Anthropic < Cosmos::Llm::Providers::Base
        ...
        # @raise [Cosmos::Llm::ServerError] If Anthropic's servers encounter an error
