...
module Cosmos
  module Llm
    module Providers
      ...
      #
      # @example Basic usage
      #   provider = Cosmos::Llm::Providers::Mistral.new(api_key: 'your_key')
      ...
      #     print chunk.to_s
      #   end
      class Mistral < Cosmos::Llm::Providers::Base
        ...
        def default_api_key
          begin
            Cosmos::Llm.configuration.mistral&.api_key
        ...
        # @raise [Cosmos::Llm::ServerError] If Mistral AI servers encounter an error
        ...
        # @raise [Cosmos::Llm::InvalidRequestError] For 4xx responses
        # @raise [Cosmos::Llm::ServerError] For 5xx responses
        # @raise [Cosmos::Llm::APIError] For unexpected response codes
        # @private
