...
module Cosmos
  module Llm
    module Providers
      ...
      class Fireworks < Cosmos::Llm::Providers::Base
        BASE_URL = 'https://api.fireworks.ai/inference/v1'

        def default_api_key
          Cosmos::Llm.configuration.fireworks&.api_key || ENV['FIREWORKS_API_KEY']
        end
        ...
        # @raise [Cosmos::Llm::AuthenticationError] If authentication fails.
        # @raise [Cosmos::Llm::RateLimitError] If rate limit is exceeded.
        # @raise [Cosmos::Llm::InvalidRequestError] If the request is invalid.
        # @raise [Cosmos::Llm::ServerError] If there's a server error.
