...
module Cosmos
  module Llm
    module Providers
      ...
      #
      # This provider implements the Cosmos::Llm::Providers::Base interface to provide
      ...
      #   provider = Cosmos::Llm::Providers::OpenAI.new(api_key: 'your-api-key')
      ...
      class OpenAI < Cosmos::Llm::Providers::Base
        BASE_URL = 'https://api.openai.com/v1'

        def default_api_key
          begin
            Cosmos::Llm.configuration.openai&.api_key
        ...
        # @raise [Cosmos::Llm::AuthenticationError] If API key is invalid
        # @raise [Cosmos::Llm::RateLimitError] If rate limit is exceeded
        # @raise [Cosmos::Llm::InvalidRequestError] If request parameters are invalid
        # @raise [Cosmos::Llm::ServerError] If OpenAI's servers encounter an error
        ...
        # @raise [Cosmos::Llm::AuthenticationError] For 401 responses
        # @raise [Cosmos::Llm::RateLimitError] For 429 responses
        # @raise [Cosmos::Llm::InvalidRequestError] For 4xx client errors
        # @raise [Cosmos::Llm::ServerError] For 5xx server errors
        # @raise [Cosmos::Llm::APIError] For unexpected status codes
