  ...
  module Llm
    ...
    class CLI < Thor
      ...
      def prompt(*prompt)
        ...
        provider_class = Cosmos::Llm::Providers.model_id_to_provider(model)
        ...
        client = Cosmos::Llm::Client.new(provider_name)
      ...
      def models
        ...
        providers.each do |provider_sym|
          ...
          provider_class = Cosmos::Llm::Providers.provider_class_for(provider_sym)
          begin
