...
module Cosmos
  module Llm
    ...
    #   begin
    #     client.complete("Hello")
    #   rescue Cosmos::Llm::AuthenticationError => e
    ...
    #   rescue Cosmos::Llm::InvalidRequestError => e
    ...
    #   rescue Cosmos::Llm::ResourceNotFoundError => e
    ...
    #   begin
    #     client.complete("Hello")
    #   rescue Cosmos::Llm::TimeoutError => e
    ...
    #   begin
    #     client.complete("Hello")
    #   rescue Cosmos::Llm::ServerError => e
    ...
    #   begin
    #     client = Cosmos::Llm::Client.new(provider: "unsupported-provider")
    #   rescue Cosmos::Llm::UnsupportedProviderError => e
    ...
    #   begin
    #     client = Cosmos::Llm::Client.new(api_key: nil)
    #   rescue Cosmos::Llm::ConfigurationError => e
    ...
    #   rescue Cosmos::Llm::ModelNotFoundError => e
    ...
    #   begin
    #     client.complete("Hello")
    #   rescue Cosmos::Llm::InsufficientQuotaError => e
    ...
    #   begin
    #     client.complete("Hello")
    #   rescue Cosmos::Llm::InvalidResponseError => e
    ...
    #   begin
    #     client.complete("Hello")
    #   rescue Cosmos::Llm::NetworkError => e
    ...
    #       puts chunk
    #     end
    #   rescue Cosmos::Llm::StreamingError => e
