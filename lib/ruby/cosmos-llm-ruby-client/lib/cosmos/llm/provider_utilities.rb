  ...
  module Llm
    ...
    module ProviderUtilities
      ...
      def models_for_provider(provider_name, **options)
        Cosmos::Llm.models(provider_name, **options)
      ...
      # @return [Array<Cosmos::Llm::Client>] Array of clients in fallback order
      ...
      def fallback_chain(providers, options = {})
        ...
        providers.map do |provider|
          ...
          Cosmos::Llm.new(provider, model: model)
      ...
      def complete_with_fallback(text, providers:, model_map: {})
        providers.each do |provider|
          begin
            client = Cosmos::Llm.new(provider, model: model_map[provider])
