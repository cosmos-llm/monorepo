...
require 'cosmos/llm/providers/openai'
require 'cosmos/llm/providers/anthropic'
require 'cosmos/llm/providers/cohere'
require 'cosmos/llm/providers/groq'
require 'cosmos/llm/providers/huggingface'
require 'cosmos/llm/providers/azure_openai'
require 'cosmos/llm/providers/deepseek'
require 'cosmos/llm/providers/fireworks'
require 'cosmos/llm/providers/google'
require 'cosmos/llm/providers/mistral'
require 'cosmos/llm/providers/opencode'
require 'cosmos/llm/providers/openrouter'
require 'cosmos/llm/providers/perplexity'
require 'cosmos/llm/providers/together'
require 'cosmos/llm/providers/xai'
      ...
      def self.providers
        @providers ||= begin
          provider_classes = constants.select do |const_name|
            ...
            const.is_a?(Class) && const < Cosmos::Llm::Providers::Base
          end
