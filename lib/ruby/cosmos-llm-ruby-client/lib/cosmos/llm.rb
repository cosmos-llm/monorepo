...
# Main entry point for the Cosmos::Llm module.
#
...
# - Azure OpenAI
#
# @see Cosmos::Llm::Client For the main client interface
# @see Cosmos::Llm::Configuration For configuration options
# @see Cosmos::Llm::Providers For available providers
...
require 'cosmos/llm/configuration'
require 'cosmos/llm/version'
...
module Cosmos
  ...
  #
  # @see Cosmos::Llm::Client
  # @see Cosmos::Llm::Configuration
  module Llm
    class << self
      ...
      # `Cosmos::Llm::Client.new(provider, options)`.
      #
      ...
      #   client = Cosmos::Llm.new(:openai, api_key: 'sk-...', model: 'gpt-4')
      # @example Create an Anthropic client
      #   client = Cosmos::Llm.new(:anthropic, api_key: 'sk-ant-...')
    ...
    #   result = Cosmos::Llm.complete('What is Ruby?', model: 'gpt-4')
    #   puts result
    # @example Quick completion with Anthropic
    #   result = Cosmos::Llm.complete('Explain AI', provider: :anthropic, model: 'claude-3-opus-20240229')
    #   puts result
...
# Users can skip this by requiring 'cosmos/llm/core' instead of 'cosmos/llm'
require 'cosmos/llm/convenience' unless ENV['DLLM_NO_CONVENIENCE']
